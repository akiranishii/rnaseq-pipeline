...
After running the RNA-seq pipeline, it is important to check the quality of raw data files, as well as the efficacy of alignment. This can be done by looking at two folders generated by the RNA-seq pipeline. 

1. First, the folder labeled "fastqc" will contain data on the quality of the raw data files. Each subfolder in the "
